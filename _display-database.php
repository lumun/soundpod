...
echo "<div class='content left-float'>";
	try 
	{
		...
		echo '<table border="1">';
		echo '<tr><td>SSN</td><td>Name</td><td>Seat</td><td>Departure</td><td>Arrival</td><td></td><td></td></tr>';
		...
		foreach ($result as $tuple)
		{
			...
			echo "<td><a href='update-flight-info'>Update</a></td>";
			echo "<td><a href='delete-flight-info'>Delete</a></td>";
			echo "</tr>";
		}
		echo "</table>";
